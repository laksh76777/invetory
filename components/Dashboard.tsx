    ...
    <div>
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="text-right flex-shrink-0">
          <p className="font-semibold text-lg text-slate-800 dark:text-slate-200">{formattedDateTime.split(',')[0]}, {formattedDateTime.split(',')[1]}</p>
          <p className="text-slate-500 dark:text-slate-400 text-sm">{formattedDateTime.split(',')[2]}</p>
        </div>
      </div>
